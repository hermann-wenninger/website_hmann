 ...
 var startx = new Date();
  urls.forEach(function (url) {
    preloadImage(url, function () {
      ...
      loadedCounter++;
      var time = new Date() - startx;
      console.log("nummer des geladenen bildes " + loadedCounter,  time/1000);
  ...
  function preloadImage(url, anImageLoadedCallback) {
    ...
    img.src = url;
     var time2 = new Date() - startx;
     console.log('sectime',time2)
  }
}
...
preloadImages(
  ...
  function () {
     ...
     console.log("Alle bilder geladen nach:");
  }
);
...
function jongani() {
  ...
  startjongleur.classList.add('unlook');
   ...
   zweitertext.textContent =
     "aber egal, mit welcher Technik wir unsere Projekte zur Marktreife stemmen ...";
    ...
    if (iterations >= 11) {
      ...
      function setClass() {
         ...
         drittertext.textContent =
           "denn ohne positive Emotionen auszulösen, bleibt eine Website nicht im Gedächtniss unserer User";
...
if (isElementInViewport(items[i])) {
          ...
          if (items[i] === start4){
            nav.style.backgroundColor = "rgb(51 51 136)";
  ...
  function addCircle(layer, fraction) {
    ...
    function firstfunc() {
      ...
      erstertext.innerHTML =
        "Dabei versuchen wir in allen Bereichen Zeit und Datenvolumen zu sparen... <br>Es heißt, den Ball flach halten...";
